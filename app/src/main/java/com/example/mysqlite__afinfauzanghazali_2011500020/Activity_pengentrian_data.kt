package com.example.mysqlite__afinfauzanghazali_2011500020

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.*

class Activity_pengentrian_data : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pengentrian_data)
        ...
        val adpSks = ArrayAdapter(
            this@Activity_pengentrian_data,
        ...
        btnSimpan.setOnClickListener {
            if ("${etKdMatkul.text}".isNotEmpty() && "${etNmMatkul.text}".isNotEmpty() &&
                ...
                val db = DbHelper(this@Activity_pengentrian_data)
